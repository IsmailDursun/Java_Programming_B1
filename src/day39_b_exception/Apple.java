...
//        logo.extension = ".png"; WebElement interface does not have accessibility to the variable
    ...
    /*
         ...
         */
    public static class Link implements WebElement{
        @Override
        public void click() {
...
without instanceof part you would be trying to cast all the object to Form, but does object dont have is a relation to Form
